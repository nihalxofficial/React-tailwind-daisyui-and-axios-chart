...
const PricingCard = (data) => {
  ...
  return (
    <div className="relative max-w-sm w-full bg-white rounded-2xl shadow-lg border border-gray-200/80 p-6">
      {/* Popular badge */}
      {card.popular? <span className="absolute -top-3 right-6 bg-indigo-600 text-white text-xs font-semibold px-4 py-1.5 rounded-full shadow-sm">
        POPULAR
      </span> :
      ""}
